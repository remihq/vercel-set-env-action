...
class VercelEnvVariabler {
    constructor(token, projectName, envVariableKeysAsString, teamId) {
        ...
        this.teamId = teamId;
        this.envVariableKeys = new Array();
        this.existingEnvVariables = { production: {}, preview: {}, development: {} };
        const envVariableKeys = envVariableKeysAsString === null || envVariableKeysAsString === void 0 ? void 0 : envVariableKeysAsString.split(",");
    ...
    populateExistingEnvVariables() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const envResponse = yield (0, vercel_1.listEnvVariables)(this.vercelClient, this.projectName);
    ...
    processEnvVariable(envVariableKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, core_1.info)(`Within parsedResult: ${JSON.stringify(parsedResult)}`);
            if (this.existingEnvVariables) {
                (0, core_1.info)(`this.existingEnvVariables: ${JSON.stringify(this.existingEnvVariables)}`);
            }
    ...
    parseAndValidateEnvVariable(envVariableKey) {
        ...
        if (!targetString) {
            throw new Error(`Variable ${envVariableKey} is missing env variable: ${`TARGET_${envVariableKey}`}`);
        }
        if (!type) {
    ...
    processPossibleEnvVariableUpdate({ type, value, targets, existingVariables, gitBranch, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (existingVariable.value !== value ||
                ...
                (0, core_1.info)(`No change found for ${existingVariable.key}, skipping...`);
            }
        });
    }
}
exports.default = VercelEnvVariabler;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core_1 = __webpack_require__(2186);
const VercelEnvVariabler_1 = __importDefault(__webpack_require__(689));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (0, core_1.getInput)("token", { required: true });
            const projectName = (0, core_1.getInput)("projectName", { required: true });
            const envVariableKeys = (0, core_1.getInput)("envVariableKeys", {
                required: true,
            });
            const teamId = (0, core_1.getInput)("teamId");
            const envVariabler = new VercelEnvVariabler_1.default(token, projectName, envVariableKeys, teamId);
            yield envVariabler.populateExistingEnvVariables();
            yield envVariabler.processEnvVariables();
            (0, core_1.info)("Vercel env variables completed successfully");
        }
        catch (error) {
            // @ts-ignore
